                        ...
                        <div class="col-12 col-md-9 col-lg-6 col-xl-4">
                            <div class="card shadow border-1 text-black bg-light bg-gradient rounded">
                                <div class="card-body p-4">
                                    <h5 class="text-center mb-4"><b>REGISTER</b></h5>

                                    <form action="{{ route('register.post') }}" method="post" accept-charset="UTF-8">
                                        {{csrf_field()}}
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="name"><b>Name</b></label>
                                            <input type="text" id="name" name="name" placeholder="name" class="form-control px-3" required />
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="d-grid pb-3">
                                            <button type="submit" name="submit" class="btn btn-info btn-block fw-bold rounded-2 text-black bg-gradient">Register</button>
                                        </div>

                                        <p class="text-center text-black mt-3 mb-0">Already have an account? <a href="{{ url('login') }}" class="text-danger" style="text-decoration:none; font-style: italic;">Login</a></p>
